        ...
        <div class="ani-block">
            <div class="content">
                ...
                <div class="thumbex">
                    ...
                    <div class="thumbnail"> <a href="javascript:void(0)">
                            <img style="object-fit: cover;" class="img-responsive img-fluid img1" src="<%=img_link1%>" alt="alt"/>
                            <img style="object-fit: cover;" class="img-responsive img-fluid img2" src="<%=img_link2%>" 
                                       alt="alt"/>
