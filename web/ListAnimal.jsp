<%-- 
    Document   : newjsp
    Created on : Feb 18, 2023, 11:13:17 AM
    Author     : ADMIN
--%>
...
<html>
    ...
    <body>
        ...
        %>
        <div class="col-ms-12" style="margin-top: 8%; margin-left: 2.5%;">
                <div class="row justify-content-center"  id="spider" style="margin-top: 1%; margin-left: 1%;">
                    ...
                    <div class="row col-md-3">
                        ...
                        <div class=".ani-block">
                            ...
                            <jsp:include page="ContentSubJSP/BlockAn.jsp" >
                                ...
                                <jsp:param name="id" value="<%=sp.get(i).getId_ani()%>" />

                                <jsp:param name="img_link1" value="<%=sp.get(i).getImg_url().get(0)%>" />

                                <jsp:param name="img_link2" value="<%=sp.get(i).getImg_url().get(1)%>" />

                                <jsp:param name="price" value="<%=sp.get(i).getPrice()[0]%>" />

                                <jsp:param name="name" value="<%=sp.get(i).getName_ani()%>" />
